...
**Contenu clé :** rappel diode et tension de seuil ; jonction PN approfondie (bandes d'énergie, dopage, sens passant/bloquant).
...
**Contenu clé :** interférences, synthèse de la partie (1h30) ; **exercices/TP d'application (1h30)** : calcul de longueur d'onde, bilan qualitatif d'une liaison.
...
**Contenu clé :** boucle ouverte vs boucle fermée ; consigne, mesure, écart, correcteur, actionneur, perturbation ; exemples concrets (thermostat, régulation de vitesse).
...
**Contenu clé :** signaux analogiques vs numériques ; notion de spectre ; introduction qualitative à la transformée de Fourier.

### Ven 19/02/2027, 09h-13h
**Objectifs :** comprendre le rôle d'un filtre et l'apport de l'amplificateur opérationnel.
**Contenu clé :** amplificateur opérationnel (montages de base) ; filtres analogiques (passe-bas, passe-haut, passe-bande), réutilisation du circuit RC déjà vu en Partie 1.
...
**Contenu clé :** échantillonnage (théorème de Shannon, approche qualitative), quantification, convertisseurs A/N et N/A.

### Mar 23/03/2027, 09h-13h
**Objectifs :** consolider l'ensemble de la partie avant le passage aux applications réseau du même mois.
**Contenu clé :** synthèse signaux/filtres/conversion A-N ; exercices transversaux (filtrage + dB + échantillonnage sur un même cas).
...
**Contenu clé :** propagation lumineuse, réflexion totale interne, principe de la fibre optique (structure cœur/gaine).

### Ven 09/04/2027, 09h-13h
**Objectifs :** relier la fibre optique aux composants optoélectroniques vus en Partie 2.
**Contenu clé :** fibre optique (suite) : atténuation, dispersion (approche qualitative), synthèse de la partie.
...
**Contenu clé :** méthodologie de traitement d'un sujet type U4 (lecture de l'énoncé, exploitation de documents techniques, rédaction), appliquée sur des exemples courts.

### Ven 23/04/2027, 14h-18h
**Objectifs :** s'entraîner sur un sujet complet dans les conditions de l'épreuve, sans perdre le contact avec la manipulation.
**Contenu clé :** **TD** : annale ou sujet type U4 traité en autonomie (2h) ; correction collective (1h) ; **micro-TP (1h)** : vérification expérimentale d'un résultat de l'annale (mesure de gain, de fréquence de coupure, etc.) sur banc de mesure ou sur Falstad si le matériel manque.

### Ven 30/04/2027, 09h-13h
**Objectifs :** évaluer le niveau de préparation dans des conditions proches de l'examen.
**Contenu clé :** épreuve blanche (1h30, format U4), reprise et échanges sur les premières impressions.

### Mar 04/05/2027, 09h-13h
**Objectifs :** clore l'année en consolidant les points faibles identifiés.
**Contenu clé :** correction détaillée de l'épreuve blanche ; bilan de l'année et des acquis par thème.
